...
const PaddleIcon = ({ className, color }) => {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
PaddleIcon.defaultProps = {
  className: '',
};

PaddleIcon.propTypes = {
...
const StartMarker = color => {
  return Leaflet.divIcon({
    className: 'leaflet-marker-divicon leaflet-startmarker',
    html: ReactDOMServer.renderToString(<PaddleIcon color={color} />),
  });
};
